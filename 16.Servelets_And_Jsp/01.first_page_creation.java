...
public class Adding_servelet extends HttpServlet  //Adding_servlet is just a class.if you extends with HttpServlet that will become servlet.
{
	...
	public void service(HttpServletRequest req,HttpServletResponse resp) throws IOException    //servlet is a server component.whenver you use servlet,you have to use service method to write logic
...
<web-app xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://xmlns.jcp.org/xml/ns/javaee" xsi:schemaLocation="http://xmlns.jcp.org/xml/ns/javaee http://xmlns.jcp.org/xml/ns/javaee/web-app_4_0.xsd" id="WebApp_ID" version="4.0">
  ...
  <servlet>
  	<servlet-name>myfirst_servlet</servlet-name>                     //your wish
  	<servlet-class>com.Servelets.Adding_servelet</servlet-class>     //servlet name with package
  </servlet>
  
  <servlet-mapping>
  	<servlet-name>myfirst_servlet</servlet-name>
  	<url-pattern>/AddTwo</url-pattern>                              //actionname of htmlpage.
  </servlet-mapping>
